...
Click the "Lunch" button to only see Lunch Items <br/>
  <br/>
<img src="./images/menu_lunch.png" height="80%" width="80%" alt="Menu"/>
<br />
<br />
  Click the "Shakes" button to only see Lunch Items <br/>
  <br/>
<img src="./images/menu_shakes.png" height="80%" width="80%" alt="Magic 8 Ball"/>
<br />
<br />
